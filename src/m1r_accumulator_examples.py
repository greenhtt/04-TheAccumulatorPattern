...
#          what expression would you use in the ____ below?
#
#            for k in range(s+1):
#
...
#           it doesnt matter what is in that value
#
...
#                  circle.attach_to(window)
#
#               THE ABOVE CODE IS WRONG BECAUSE x = x + diameter IS NOT THERE SO THE CODE WILL MERELY PRINT THE SAME CIRCLES OVER AND OVER AGAIN
#
#              x = starting_point.x
#              for k in range(n):
#                  center = rg.Point(x + (k * diameter), y)
